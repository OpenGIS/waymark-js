...
- Data layers are re-applied after style reloads so `data.layers` overlays persist across runtime style changes (including internal vector basemap switches).
